    ...
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center">
        <div className="text-center">
          <p className="text-xl text-zinc-400 mb-4">אתה צריך להתחבר כדי ליצור תכנית</p>
          <Link href="/" className="text-purple-400 hover:text-purple-300">חזרה לדף הבית</Link>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <Link href="/programs" className="text-purple-400 hover:text-purple-300 mb-6 inline-block">
          ← חזרה לתכניות
        </Link>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-3">
            <button
              type="submit"
              disabled={loading}
              className="flex-1 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold px-6 py-3 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50"
            >
